...
class TvDatafeedLive(trading_view_services.TvDatafeed):
    """                 
    ...
    def new_seis(self, symbol, exchange, interval, timeout=-1): 
        ...
        new_seis=trading_view_services.Seis(symbol, exchange, interval)
    ...
    def new_consumer(self, seis, callback, timeout=-1):
        ...
        consumer=trading_view_services.Consumer(seis, callback)
        if self._lock.acquire(timeout=timeout) is False:
            return False
    ...
    def get_hist(self,  
        symbol: str,
        exchange: str = "NSE",
        interval: trading_view_services.Interval = trading_view_services.Interval.in_daily,
        n_bars: int = 10,
