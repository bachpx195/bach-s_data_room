...
module CandlestickServices
  class CreateMonthService
    ...
    def test_api
      merchandise_rate= MerchandiseRate.find(34)
      start_time = Time.at(FIRST_DATE_IN_BINANCE[merchandise_rate.base.slug.to_sym]).to_datetime.to_i
      BinanceServices::Request.send!(
        path: "/api/v3/klines",
